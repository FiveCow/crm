										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>联系人名称：</TD>
													<TD>
													<s:textfield name="lkm_name" cssClass="textbox" cssStyle="WIDTH: 80px" id="sChannel2"></s:textfield>
													</TD>													
													<TD>
														<s:select list="#{'0':'男','1':'女' }" name="lkm_gender" headerKey="" headerValue="-请选择-" ></s:select>
													</TD>													
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												共[<B><s:property value="count"/> </B>]条记录,[<B><s:property value="totalPage"/> </B>]页
												,每页显示
